# Contributing to tor-spring-boot-starter
...
The [issue tracker](https://github.com/theborakompanioni/tor-spring-boot-starter/issues) is
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/tor-spring-boot-starter.git
   # Navigate to the newly cloned directory
   cd tor-spring-boot-starter
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/theborakompanioni/tor-spring-boot-starter.git
   ```
